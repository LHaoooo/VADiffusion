...
def MNADTrain():
    ...
    trainset_yuvroot=os.path.join(args.dataset_path, "train_recyuv400/")

    # Loading dataset
    dataset = VideoDataset(args.c, trainset_yuvroot) 
    train_batch = data.DataLoader(dataset=dataset, batch_size=args.batch_size, 
    ...
    for epoch in range(args.epochs):
        ...
        model.train()
        for j,(imgs, _, _) in enumerate(train_batch):
